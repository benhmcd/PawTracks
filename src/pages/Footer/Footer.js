    ...
    return (
        <>
            <div className='footer'>
                <Link to="/" className='footer-logo' ><img src='/pawTracksCircleLogo512.png' id='header-logo'></img><h1 id='pawTracksLogo'> Paw Tracks</h1></Link>
                <a href="https://github.com/benhmcd/PawTracks" target="_blank" className='github_link' ><h5> <AiOutlineGithub/> Github Repository </h5></a>
                <nav ref={footRef}>
